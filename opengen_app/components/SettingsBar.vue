    ...
    <div class="flex flex-row-reverse w-full">
        ...
        <!-- <aside class="flex w-full"> -->
            <div
                ...
                <div class="mb-4 flex items-center gap-x-2 px-2 text-slate-800 dark:text-slate-200">
                    <button class="inline-flex rounded-lg p-1 hover:bg-slate-700">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" stroke-width="2" stroke="currentColor"
                ...
                <div class="px-2 py-4">
                    <label class="relative flex cursor-pointer items-center">
                        ...
                        <span class="ml-3 text-sm font-medium text-slate-800 dark:text-slate-200">Toggle</span>
                    </label>
                </div>
                <!-- More Settings -->
                <div
                    class="my-4 border-t border-slate-300 px-2 py-4 text-slate-800 dark:border-slate-700 dark:text-slate-200">
                    <label class="px-2 text-xs uppercase text-slate-500 dark:text-slate-400">Advanced</label>

                    <label for="api-key" class="mb-2 mt-4 block px-2 text-sm font-medium">API Key</label>
                    ...
                    <label for="base-url" class="mb-2 mt-4 block px-2 text-sm font-medium">Base URL</label>
                    <input type="url" id="base-url"
                        class="block w-full rounded-lg bg-slate-200 p-2.5 text-xs focus:outline-none focus:ring-2 focus:ring-blue-600 dark:bg-slate-800 dark:placeholder-slate-400 dark:focus:ring-blue-600"
                        placeholder="https://api.openai.com" />

                    <label for="select-model" class="mb-2 mt-4 block px-2 text-sm font-medium">Model</label>
                    ...
                    <label for="max-tokens" class="mb-2 mt-4 block px-2 text-sm font-medium">Max tokens</label>
                    <input type="number" id="max-tokens"
                        class="block w-full rounded-lg bg-slate-200 p-2.5 text-xs focus:outline-none focus:ring-2 focus:ring-blue-600 dark:bg-slate-800 dark:placeholder-slate-400 dark:focus:ring-blue-600"
                        placeholder="2048" />

                    <label for="max-tokens" class="mb-2 mt-4 block px-2 text-sm font-medium">Temperature</label>
                    <input type="number" id="max-tokens"
                        class="block w-full rounded-lg bg-slate-200 p-2.5 text-xs focus:outline-none focus:ring-2 focus:ring-blue-600 dark:bg-slate-800 dark:placeholder-slate-400 dark:focus:ring-blue-600"
                        placeholder="0.7" />

                    <label for="top-p" class="mb-2 mt-4 block px-2 text-sm font-medium">Top P</label>
                    <input type="number" id="top-p"
                        class="block w-full rounded-lg bg-slate-200 p-2.5 text-xs focus:outline-none focus:ring-2 focus:ring-blue-600 dark:bg-slate-800 dark:placeholder-slate-400 dark:focus:ring-blue-600"
                        placeholder="1" />
